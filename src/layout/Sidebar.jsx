...
<div className='hidden lg:flex fixed flex-col  top-[35%] right-0 '>
    <ul>
        ...
        <li className='w-[70px] h-[60px] flex justify-between items-center mr-[-100px] duration-300 bg-[#b4bfc5] bg-opacity-0 hover:bg-blue-600'>
            <a className='flex justify-evenly items-center w-full text-gray-300'
            href="https://www.linkedin.com/in/adedamola-ajasa" rel='noopener noreferrer' target={'_blank'}>
            <FaLinkedin size={30}/> 
            </a>
        </li>
        <li className='w-[70px] h-[60px] flex justify-between items-center mr-[-100px]  duration-300  bg-opacity-0 hover:bg-black'>
            <a className='flex justify-evenly items-center w-full text-gray-300'
            href="https://www.github.com/damoxify"rel='noopener noreferrer' target={'_blank'}>
               <FaGithub size={30}/> 
            </a>
        </li>  <li className='w-[70px] h-[60px] flex justify-between items-center mr-[-100px] duration-300  bg-opacity-0 hover:bg-[#0b3b30]'>
            <a className='flex justify-evenly items-center w-full text-gray-300'
            href="/" rel='noopener noreferrer' target={'_blank'}>
                 <HiOutlineMail size={30}/>
            </a>
        </li>  <li className='w-[70px] h-[60px] flex justify-between items-center mr-[-100px]  duration-300  bg-opacity-0 hover:bg-[#234c5a]'>
            <a className='flex justify-evenly items-center w-full text-gray-300'
